...
<body>
    ...
    <main>
        <section>
            <div class="container-fluid">
                <br>
                <img src="imagens/carro_logo.png" width="20%" height="20%">
                <h3>ALUGUE SEU VEICULO COM SEGURANÇA E CREDIBILIDADE</h3>
                <br>
            </div>
                    ...
                    <div class="col-6">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <!--HEADER-->
                                <h4 class="my-0 fw-normal">Situação da Reserva</h4>
                            </div>
                            <div class="card-body">
                                <!--BODY-->

                                <form action="editar2.php?posicao=<?php echo $posicao; ?>" method="POST">
                                    <div class="form-group">
                                        <label>Início da Reserva:</label>
                                        <p><?php echo $veiculo[$posicao]; ?></p>
                                        
                                        <label>Fim da Reserva:</label>
                                        <p><?php echo $veiculo[$posicao + 1]; ?></p>

                                        <label>Veículo:</label>
                                        <p><?php echo $veiculo[$posicao + 2]; ?></p>

                                    <input class="form-check-input" type="radio" name="estado" id="estado" value="Confirmada" checked>
                                    <label class="form-check-label" for="estado"><b>CONFIRMAR</b></label>
