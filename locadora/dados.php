                         ...
                         <div class="col">    
                             <div class="card mb-4 rounded-3 shadow-sm">
                                <div class="card-header py-3 "><!--HEADER-->
                                    <h4 class="my-0 fw-normal">Resumo da Reserva</h4>
                                </div>
                                <div class="card-body"><!--BODY-->                                                                            
                                        <ul>
                                        <li>Início da reserva: <?= $dados2['inicio']?></li>  
                                        <li>Fim da Reserva: <?= $dados2['fim']?> </li> 
                                        <li>Veículo: <?= $dados2['reservar']?> </li>                                         
                                        </ul>
                                    <hr><br><br>
                                    <!--BOTÃO ACESSAR-->
                                    <div class="position-relative">
                                        <div class="position-absolute bottom-0 end-0">                                
                                            <a href="reservas2.php"><button type="button" class="btn btn btn-outline-danger btn-md">Acessar Reserva</button></a>
                                        </div>
                                    </div>                                            
                                 </div>
                             </div>
